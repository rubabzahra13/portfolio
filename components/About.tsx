...
export function About() {
  return (
    <section id="about-me" className="py-24 px-6 bg-[#0f0f14]">
      <div className="max-w-5xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="rounded-xl bg-gradient-to-br from-violet-900/40 to-indigo-900/40 border border-zinc-700/50 p-6">
